      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className={`${openMenu ? "block" : "hidden"} lg:hidden pb-6`}>
          <div className="relative mb-6 mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-4 h-4 text-[#4A4036] absolute left-0 top-1/2 -translate-y-1/2"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth="2"
            ...
            <input
              ...
              className="w-full bg-transparent border-b border-[#1F1A14] pl-8 pr-2 py-2 text-sm focus:outline-none placeholder:text-[#4A4036]"
            />
          </div>
